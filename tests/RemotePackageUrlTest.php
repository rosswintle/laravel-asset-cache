...
class RemotePackageUrlTest extends TestCase
{
	...
	{
		$jpm = new LaravelJPM();
		$url = $jpm->remotePackageUrl('jquery', '3.2.1', 'dist/jquery.min.js');
	...
	{
		$jpm = new LaravelJPM();
		$url = $jpm->remotePackageUrl('jquery', '3.2.1');
	...
	{
		$jpm = new LaravelJPM();
		$url = $jpm->remotePackageUrl('jquery', '', 'dist/jquery.min.js');
	...
	{
		$jpm = new LaravelJPM();
		$url = $jpm->remotePackageUrl('jquery');
